...
FetchFoods useFetchFoodsByCategories(String categoryId) {
  ...
  Future<void> fetchData() async {
    ...
    try {
      final  url = Uri.parse("$appBaseUrl/api/food/category/list/$categoryId");    
      
      final response = await http.get(url);
      print("useFetchFoodsByCategory: ${response.statusCode}");
      print(response.body);
