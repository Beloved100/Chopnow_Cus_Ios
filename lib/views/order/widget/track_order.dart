...
import 'package:chopnow/controllers/notification_order_controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
          ...
          child: Container(
            child: Obx(() {
              return controller.showRatingSubmitted.value || controller.showRatingRatingSubmitted.value
                  ? Container(
                          ...
                          Expanded(
                            child: Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                    onTap: () {
                                      controller.showRatingSubmitted.value =
                                          false;
                                    },
                                    child: Icon(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() {
                    return Row(
                      children: [
                        if(order.restaurantRating == false && controller.showOrderRatingButton.value == true)
                        Expanded(
                          child: RatingButton(
                            order: order,
                          ),
                        ...
                        SizedBox(width: 10.w,),
                        if(order.riderRating == false && controller.showRiderRatingButton.value == true)
                        Expanded(child: RiderRatingButton(order: order, riderUser: riderUser.value,))
                      ],
                    );
                  }),
                ...
                children: [
                  ...
                  RiderDetails(
                    onTap: riderUser.value != null
                        ? () async {
                            final Uri phoneUri =
                                Uri.parse("tel:${riderUser.value!.phone}");
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextnPriceWidget(
                    title: 'Service fee',
                    title1: "${((order.orderTotal) * 0.10).round()}",
                  ),
                  SizedBox(height: 30.h),
                  TextnPriceWidget(
                    title: 'Delivery Fee',
